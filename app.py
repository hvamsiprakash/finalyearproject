...
st.title("Image Captioning App")
st.write("""
This is a final year project that uses a deep learning model to generate captions for images. 
The model is based on a CNN for image feature extraction and a Transformer for caption generation.
""")

# Check if the model is loaded
if model is not None and vectorization is not None:
    st.success("Model and vocabulary loaded successfully!")
else:
    st.error("Failed to load the model or vocabulary. Please check the files.")
